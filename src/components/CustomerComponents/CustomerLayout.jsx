...
import { SelectedLinkProvider } from './CustomerSelectedLinkContext';
...
export default function CustomerLayout() {
  ...
  const hideLayoutRoutes = ['/customerhome/customernotifications', '/customerhome/somethingelse']; // Add routes as needed
