...
import { useSelectedLink } from './SellerSelectedLinkContext'
  ...
  return <div className='bg-[#0a042d] h-12 px-4 w-[100%] relative flex fles-row '>
            ...
            <div className='absolute inset-y-0 right-0 mr-7 flex w-20'>
              <div className='flex flex-1 gap-4 my-3'>
                <FaUser size={20} style={{ color: '#FF5733'}} className='cursor-pointer' onClick={() => navigate ('/selleraccount')}/>

                <FaBell size={20} style={{ color: '#FF5733'}} className='cursor-pointer' onClick={() => navigate ('/sellernotifications')}/>
              
                <FaComments size={20} style={{ color: '#FF5733'}} className='cursor-pointer' onClick={() => navigate ('/sellermessages')}/>
              </div>
