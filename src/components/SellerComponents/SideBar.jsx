...
const menus = [
  {name: "Dashboard", link: '/sellerhome',icon: FaThLarge},
  {name: "Orders", link: 'orders',icon: FaCartArrowDown},
  {name: "Request Stocks", link: 'requeststocks',icon: FaEdit},
  {name: "Complaints", link: 'complaints',icon: FaExclamationCircle},
